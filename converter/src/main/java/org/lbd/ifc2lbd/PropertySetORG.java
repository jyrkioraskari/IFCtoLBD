...
public class PropertySetORG {
	...
	public PropertySetORG(String uriBase, Model model, Model ontology_model,String name, int props_level,
	...
	public PropertySetORG(String uriBase, Model model,String name, int props_level,
