...
public abstract class LBD_RDF_Utils {
     ...
     * and Co. (The OPEN IFC JAVA TOOLBOX)
     * 
     * @param r
     ...
     * @param ifcOWL_ns
     *            the ifcOWL name space class instance
     * @param uriBase
     *            the used base URI
     * @return Returns the created LBD Jena resource
     */
    public static Resource createformattedURIRecource(Resource r, Model m, String product_type, IfcOWL ifcOWL_ns, String uriBase, boolean exportIfcOWL) {
