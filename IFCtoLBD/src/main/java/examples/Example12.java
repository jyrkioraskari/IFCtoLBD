    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (IFCtoLBDConverter converter = new IFCtoLBDConverter("https://example.com/", hasPropertiesBlankNodes, props_level);) {
                ...
                // Create a map to replace property URIs
                Map<String, String> map = new HashMap<>();
                map.put("http://lbd.arch.rwth-aachen.de/props#globalIdIfcRoot_attribute_simple", "https://my.org/guid");  // Replace property URI
